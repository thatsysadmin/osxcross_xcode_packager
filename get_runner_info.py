...
system_info = subprocess.check_output("uname -a", shell=True).decode()
xcode_version = subprocess.check_output("xcodebuild -version", shell=True).decode()
softwareupdate_history = subprocess.check_output("softwareupdate --history", shell=True).decode()
runner_information = subprocess.check_output("system_profiler SPSoftwareDataType SPHardwareDataType", shell=True).decode()
